<template>
  <NDropdown
    ...
    :on-select="onSelect"
  >
    <NSkeleton v-if="!auth" class="h-14 mr-6" />
    <NButton v-else :theme-overrides="buttonThemeOverrides" style="height: 3.5rem;" class="rounded px-4 py-2 text-sm font-semibold leading-6 text-white border border-red-300 cursor-default">
